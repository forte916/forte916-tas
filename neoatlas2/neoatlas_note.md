...
## Chart
* NewGame の前に Option からウィンドウを早いに変更
* プロローグが終わり、アラビアンナイト付近にカーソルが表示されると操作可能になる
	* speed 早い
	* アラビアンナイトは無視し、カーソルを左に移動
	* 真西に進むとスフィンクス 30000G
	* scale 3, アルマゲスト発見
* ペレスが提督になったら
	* ペレスをベルダに移動
...
* ペレスの報告後
	...
	* ベルダ南東を探索
		* 造船技術書発見
		* 発見した産物(コーヒー)と北欧の二次産物(ワイン、黒真珠)と貿易するとよい


* 序盤のアイテム
	| ペリカン容器       | 観察力+1.5 | トルコ付近           | scale 2 |
	| 幸福のオノ         | 友好度+2.0 | フランス付近         | scale 2 |
	| ドワーフ砲         | 戦闘力+1.5 | スコットランド付近   | scale 2 |
	| ラップランドのゴマ | 観察力+1.0 | クロイツカディア付近 | scale 3 |
	| イチゴ             | 友好度+0.5 | ジェノバ真北         | scale 4 |

	* イチゴは scale 4 かつ効果が低いので特に必要なし
...
* 提督が 2人になるとペレスのイベント
	...
	* 探検航路 1本追加
* 航海を進めるとラグナールイベント
	* ラグナールイベント 3回のあとバルディ加入
	* 探検航路 1追加
* 147X/10/10
	* 資金100万越えるとケサダ, 50万で貿易航路 1本
